...
def main():
    DoActions([
        ...
        SetMemory(0x58D088 + 1 * 46 + 18, Add, 2*65536),
        SetMemory(0x58D088 + 2 * 46 + 18, Add, 2),
        SetMemory(0x58D088 + 3 * 46 + 18, Add, 2*65536),
        SetMemory(0x58D088 + 4 * 46 + 18, Add, 2),
        SetMemory(0x58D088 + 5 * 46 + 18, Add, 2*65536),
        SetMemory(0x58D088 + 6 * 46 + 18, Add, 2),
        SetMemory(0x58D088 + 7 * 46 + 18, Add, 2*65536),
    ])
